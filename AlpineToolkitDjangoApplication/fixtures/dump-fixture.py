...
#
# Alpine Toolkit - 
# Copyright (C) Salvaire Fabrice 2017
#
...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "AlpineToolkitDjangoSite.settings")
django.setup()

# from AlpineToolkitDjangoApplication import models

from django.contrib.auth.models import User

from AlpineToolkitDjangoApplication.models import (
    Profile,
)
